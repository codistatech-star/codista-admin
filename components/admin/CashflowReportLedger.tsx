...
export function CashflowReportLedger({ entries }: { entries: CashflowLedgerRow[] }) {
  ...
  return (
    <section className="admin-card overflow-visible">
      <div className="sticky top-0 z-20 -mx-5 -mt-5 mb-4 space-y-3 border-b border-[var(--admin-border)] bg-white px-5 pb-3 pt-5">
        ...
        <input
          ...
          placeholder="Search date, account, type, category…"
          aria-label="Search date, account, type, category…"
        />
      </div>
